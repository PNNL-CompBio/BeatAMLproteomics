...
## Get Data
This calls the standard data loading function that exists at `../../util/loading_data.R`. 
Once it is loaded it should not have to be reloaded. 
...
## Here we define analogous objects to auc.dat, full.pats, etc 
...
# png("prot_heatmap_full_legend.png", height = 600, width = 600)
...
pheatmap(ph.mat[,rownames(fannotes)],
         cluster_rows = TRUE,cellheight=8,
         #clustering_distance_cols = 'correlation',
...
p<-cowplot::plot_grid(plotlist=dotplots, ncol=2)
p
ggsave('flt3_phosphoDotPlots.pdf',p,width=8,height=12)
