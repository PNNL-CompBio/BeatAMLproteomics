...
m$`FLT3 Mutation` <- m$FLT3.ITD
pData(m) <- pData(m) %>% dplyr::rename(`Specimen Type` = specimen.type)

pdf(file="beataml_proteomics_pca.pdf",
    width=6,height=6)
plot_pca_ex10(m, colorBy="FLT3 Mutation", shapeBy="Specimen Type") +
...
pdf(file="beataml_phosphoproteomics_pca.pdf",
    width=6,height=6)
plot_pca_ex10(m, colorBy="FLT3 Mutation", shapeBy="Specimen Type") +
