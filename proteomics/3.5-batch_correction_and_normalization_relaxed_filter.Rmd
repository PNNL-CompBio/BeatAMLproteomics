...
#######################################################
# debug(WGCNA::empiricalBayesLM)
failed.sites <- read.table("../proteomics/Failed acetyl Regression.txt")[-1, ]
...
#######################################################
# debug(WGCNA::empiricalBayesLM)
failed.sites <- read.table("../proteomics/Failed acetyl peptide Regression.txt")[-1, ]
m2 <- m[!(rownames(m) %in% failed.sites), ]
m3 <- correct_batch_effect_empiricalBayesLM(m2, removed_covariates) # Warning: Found missing and/or non-finite data. These will be removed.
# Error in solve.default(prior.covar) : 
#  system is computationally singular: reciprocal condition number = 1.28073e-22
# Error occurred at i = 84
