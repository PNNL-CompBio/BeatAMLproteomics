...
corrected.synapse <- read.table("data/Batch Correction/ptrc_ex10_crosstab_phospho_siteID_corrected.txt", check.names = F, sep = "\t")
...
## The regression (used to estimate batch and loading mass effect) fails for 769
## Phosphosites. Reason has to do with the design matrix in regression not having full rank.
## To see what the 769 sites are, debug WGCNA::empiricalBayesLM and proceed past line 250. This ensures 
...
synTableStore(data, "BeatAML Phosphoproteomics relaxed_filter_corrected", parentId = 'syn22128879')
