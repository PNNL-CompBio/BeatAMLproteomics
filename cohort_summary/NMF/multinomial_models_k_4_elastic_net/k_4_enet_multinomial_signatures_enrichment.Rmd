...
get_enrichment <- function(t2g_name, data_type){
  ...
  all_signature_enrichment <- lapply(c("1", "2", "3", "4"), function(chosen_cluster){
...
```{r}
plots_enrichment <- plot_enrichment(0.7)

ggsave("enet_multinomial_data/signature_enrichment_alpha_0.7_Global.pdf", width = 15, height = 14, plot = plots_enrichment[[1]])
ggsave("enet_multinomial_data/signature_enrichment_alpha_0.7_RNA.pdf", width = 15, height = 14, plot = plots_enrichment[[2]])
