...
ggsave("enet_multinomial_data/global_prediction_survival_alpha_0.7_all_samples.pdf",
       width = 7, height = 7, plot = prediction_survival_plots[[2]])
ggsave("enet_multinomial_data/global_prediction_survival_alpha_0.7_heldout_samples.pdf",
       width = 7, height = 7, plot = prediction_survival_plots[[3]])

prediction_survival_plots <- make_prediction_plot(0.7, "Combined", robust = TRUE)
ggsave("enet_multinomial_data/combined_prediction_survival_alpha_0.7_all_samples.pdf",
       width = 7, height = 7, plot = prediction_survival_plots[[2]])
ggsave("enet_multinomial_data/combined_prediction_survival_alpha_0.7_heldout_samples.pdf",
       width = 7, height = 7, plot = prediction_survival_plots[[3]])

prediction_survival_plots <- make_prediction_plot(0.7, "Phospho_imp", robust = TRUE)
ggsave("enet_multinomial_data/phosphoImp_prediction_survival_alpha_0.7_all_samples.pdf",
       width = 7, height = 7, plot = prediction_survival_plots[[2]])
ggsave("enet_multinomial_data/phosphoImp_prediction_survival_alpha_0.7_heldout_samples.pdf",
       width = 7, height = 7, plot = prediction_survival_plots[[3]])
...
mat_HL60 <- mat_HL60[rownames(global_mat_train), ]
...
mat_MOLM14 <- mat_MOLM14[rownames(global_mat_train), ]
...
pilot_subtypes <- subtype_prediction(mat_pilot, metadata_pilot) %>%
  mutate(Time = "Dummy", Treatment = "Dummy") %>%
...
p2 <- ggsurvplot(sfit, color = "pred_cluster", data = pilot_subtypes,
                 palette = subtype_colors, pval = TRUE)$plot +
        theme(legend.text = element_text(size = 12, color = "black"),
              legend.title = element_text(size = 12, color = "black"))
