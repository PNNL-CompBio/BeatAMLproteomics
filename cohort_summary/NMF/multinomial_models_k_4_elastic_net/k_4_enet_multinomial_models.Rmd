...
bound_mult <- 1.0
bounds <- lapply(list(global_mat_train, phospho_mat_train, RNA_mat_train, phospho_mat_train_imp, combined_mat_train), function(data_mat){
  print(nrow(data_mat))
...
results_phospho_imp <- run_cv_gric(phospho_mat_train_imp)
...
all_results <- list("Global" = results_global,
                    ...
                    "Global + Phospho_imp" = results_combined)
