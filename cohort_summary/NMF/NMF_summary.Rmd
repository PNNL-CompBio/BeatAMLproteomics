...
name <- "Data/survival_plots_by_cluster_k_3.png"
png(filename = name)
...
name <- "Data/survival_plots_by_cluster_k_4.png"
png(filename = name)
...
name <- "Data/survival_plots_by_cluster_k_5.png"
png(filename = name)
...
name <- "Data/survival_plots_by_cluster_k_8.png"
png(filename = name)
...
sfit <- survfit(Surv(overallSurvival, vitalStatus) ~ k2, data = kaplan.df.full)

name <- "Data/survival_plots_by_cluster_k_2.pdf"
ggsurvplot(sfit, palette = chosen.colors[1:2])
ggsave(file = name)
...
sfit <- survfit(Surv(overallSurvival, vitalStatus) ~ k6, data = kaplan.df.full)

name <- "Data/survival_plots_by_cluster_k_6.pdf"
ggsurvplot(sfit, palette = chosen.colors[1:6])
ggsave(file = name)
...
sfit <- survfit(Surv(overallSurvival, vitalStatus) ~ k7, data = kaplan.df.full)

name <- "Data/survival_plots_by_cluster_k_7.pdf"
ggsurvplot(sfit, palette = chosen.colors[1:7])
ggsave(file = name)
...
ggsurvplot(sfit, palette = chosen.colors[1:8])
ggsave(file = name)
